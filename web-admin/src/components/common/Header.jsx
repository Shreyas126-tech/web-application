            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden lg:flex space-x-1 items-center">
                        ...
                        <Link to="/online-seva" className="text-orange-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">Online Seva</Link>
                        <Link to="/kanike" className="text-orange-100 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">e-Kanike</Link>
            ...
            {isMenuOpen && (
                <div className="lg:hidden bg-orange-800">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <Link to="/online-seva" className="text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-orange-600">Online Seva</Link>
                        <Link to="/kanike" className="text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-orange-600">e-Kanike</Link>
